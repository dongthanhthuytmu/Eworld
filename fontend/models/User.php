...
class User extends Model {
	...
	public function register($first_name, $last_name, $phone, $email, $password, $address) {
		$obj_insert = $this->connection->prepare('INSERT INTO users(first_name, last_name, phone, email, password, address) VALUES (:first_name, :last_name, :phone, :email, :password, :address)');
		$inserts = [
