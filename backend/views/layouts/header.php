        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <div class="home text-center">   
              <a target="_blank" class="btn btn-info" style="color: black;" href="http://localhost:8080/eworld/fontend/"><i class="fas fa-home"></i> </a>
            </div>
          </div>
        </div>
        <!-- /sidebar menu -->
          ...
          <ul class=" navbar-right">
            <li class="nav-item dropdown open" style="padding-left: 15px;">
              ...
              <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item"  href="http://localhost:8080/project-ITPlus/backend/index.php?controller=user&action=info"> Hồ sơ cá nhân</a>
                <a class="dropdown-item"  href="http://localhost:8080/project-ITPlus/backend/index.php?controller=user&action=logout"><i class="fa fa-sign-out pull-right"></i> Đăng xuất</a>
              </div>
            </li>
          </ul>
        </nav>
